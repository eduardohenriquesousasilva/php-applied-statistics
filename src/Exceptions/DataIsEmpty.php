...
{
    /**
     * Default message that will show when data wasn't defined
     */
    const MESSAGE_ERROR = 'The data to calculate wasn\'t defined';
    ...
    public function __toString() {
        return __CLASS__ . ": [DataIsEmpty]: {$this->message}\n";
    }
}