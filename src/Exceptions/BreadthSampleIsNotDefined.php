...
class BreadthSampleIsNotDefined extends Exception
{
    /**
     * Default message that will show when breadth sample wasn't defined
     */
    const MESSAGE_ERROR = 'The breadth sample wasn\'t defined';
    ...
    public function __toString() {
        return __CLASS__ . ": [BreadthSampleIsNotDefined]: {$this->message}\n";
    }
}