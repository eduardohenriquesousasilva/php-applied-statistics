...
class IntervalClassIsNotDefined extends Exception
{
    /**
     * Default message that will show when interval class wasn't defined
     */
    const MESSAGE_ERROR = 'The interval class wasn\'t defined';
    ...
    public function __toString() {
        return __CLASS__ . ": [IntervalClassIsNotDefined]: {$this->message}\n";
    }
}