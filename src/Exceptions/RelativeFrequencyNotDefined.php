...
class RelativeFrequencyNotDefined extends Exception
{
    /**
     * Default message that will show when relative frequency
     * wasn't defined
     */
    const MESSAGE_ERROR = 'The relative frequency wasn\'t defined';
    ...
    public function __toString() {
        return __CLASS__ . ": [RelativeFrequencyNotDefined]: {$this->message}\n";
    }
}